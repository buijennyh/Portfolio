  ...
  return (
    <div name='home' className='w-full h-screen bg-[#F0F2DC] text-slate-900'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <div>
          <button className='text-[#260906] border-4 px-6 py-3 my-2 flex items-center hover:bg-[#8C8274] hover:border-[#402C25]'>View Work <HiArrowNarrowRight className='ml-3'/>
          </button>  
        </div>
      </div>
